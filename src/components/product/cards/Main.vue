<template>
  ...
  >
    <div
      class="flex flex-col bg-theme-dark-2 shadow-lg rounded-lg max-w-md mx-auto p-2 h-full card"
    >
      <div class="flex-shrink-0 rounded-lg">
        <img
          :src="product.image"
          alt="Product image"
          class="h-32 lg:h-48 w-full object-cover rounded-lg"
        />
      </div>
      <div class="flex-1 mt-4">
        ...
        <div
          class="flex items-center flex-row justify-center text-left mt-4 w-full"
        >
        ...
        <div class="flex items-center mt-4 space-x-4 grid grid-cols-3">
          <button
            class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-opacity-50 col-span-2 flex flex-row items-center justify-center"
          >
            <i class="fa fa-cart-plus" aria-hidden="true"></i>
            <span class="hidden lg:block">Add to cart</span>
          </button>
          <button
            class="bg-gray-200 text-gray-900 px-4 py-2 rounded-lg hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200 focus:ring-opacity-50 col-span-1 flex flex-row items-center justify-center"
          >
