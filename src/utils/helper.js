...
const helpers = {
  ...
  /**
   * @param    {String} date    Default format(21/12/2019)
   * @param    {String} format    Accepted format("D MMM 'YY"). Refer to https://day.js.org/ for more options
   **/
  ...
  formatTitle(title) {
    title = title.replace(/[^a-zA-Z ]/g, "").replaceAll(" ", "-").toLowerCase();
    return title;
  }
};
